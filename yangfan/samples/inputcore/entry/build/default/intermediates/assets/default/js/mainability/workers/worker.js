...
var lable = '02800::MultimodalinputWorkerJsWorker';

parentPort.onmessage = function (e) {
  var _this = this;

  console.info("".concat(lable, ":MultimodalInputDevice_on_test enter"));
  ...
  _ohosMultimodalInput["default"].on("change", function (data) {
    ...
    console.info("".concat(lable, ":type:") + data.type + ", deviceId: " + data.deviceId);

    _ohosMultimodalInput["default"].getKeyboardType(data.deviceId, function (err, ret) {
      (0, _newArrowCheck2["default"])(this, _this2);
      console.info("".concat(lable, ":The keyboard type of the device is:") + ret);
  ...
  console.log("".concat(lable, ":MultimodalInputDevice_on_test: receive from main thread:  ").concat(JSON.stringify(e.data)));
  var data = e.data + "; hello main";
  parentPort.postMessage(data);
  console.info("".concat(lable, ":MultimodalInputDevice_on_test leave"));
};
